...
while($row = mysqli_fetch_array($covid)){
	...
	$query = mysqli_query($koneksi,"select sum(total_deaths) as total_deaths from tb_covid where id_country ='".$row['id_country']."'");
...
<head>
	<title>Total Data Meninggal </title>
...
<body>
    <center><h3>Total Data Meninggal</h3></center>
